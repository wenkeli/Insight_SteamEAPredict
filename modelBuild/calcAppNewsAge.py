...
appList["now-FN"] = (nowTS - appList["FNTS"]) / nSPDay

appList=appList[["appID", "R-FN", "now-LN", "now-FN", "FNTS", "LNTS"]].copy()
appList.to_json("appAttrs/appNewsAges.json")

appList = pd.read_json("appAttrs/appNewsAges.json", encoding="utf-8")
plotDir = "plots"
